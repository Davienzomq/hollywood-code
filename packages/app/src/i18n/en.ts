export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by Hollycode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in Hollycode.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in Hollycode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in Hollycode.",
  ...
  "dialog.server.description": "Switch which Hollycode server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "Hollycode",
  ...
  "wsl.onboarding.checkingOpencode": "Checking Hollycode...",
  "wsl.onboarding.checkingOpencodeIn": "Checking Hollycode in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating Hollycode...",
  "wsl.onboarding.updatingOpencodeIn": "Updating Hollycode in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update Hollycode in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update Hollycode",
  "wsl.onboarding.opencodeReadyIn": "Hollycode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "Hollycode is ready.",
  "wsl.onboarding.installOpencodeIn": "Install Hollycode in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install Hollycode",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen Hollycode.",
  ...
  "toast.update.description": "A new version of Hollycode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the Hollycode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Hollycode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Hollycode includes free models so you can start immediately.",
  ...
  "app.name.desktop": "Hollycode Desktop",
  ...
  "settings.desktop.wsl.description": "Run the Hollycode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for Hollycode",
  ...
  "settings.general.row.appearance.description": "Customise how Hollycode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether Hollycode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how Hollycode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when Hollycode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of Hollycode.",
