...
```python
import sys
sys.path.insert(0, "/home/teknium/.hollycode/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.hollycode/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Hollycode installs package this)
