...
author: Hollycode (adapted from ShinMegamiBoson/OpenPlanter, MIT)
metadata:
  hollycode:
...
# $HOLLYCODE_OSINT_CACHE/icij/ (default: ~/.cache/hollycode-osint/icij/).
...
# Set HOLLYCODE_OSINT_UA=your-app/1.0 (your@email) to identify yourself
