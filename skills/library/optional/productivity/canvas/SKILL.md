...
4. Name the token (e.g., "Hollycode"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${HOLLYCODE_HOME:-~/.hollycode}/.env`:
...
```bash
CANVAS="python $HOLLYCODE_HOME/skills/productivity/canvas/scripts/canvas_api.py"
