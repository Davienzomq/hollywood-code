...
Data file: $HOLLYCODE_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_HOLLYCODE_HOME = Path(os.environ.get("HOLLYCODE_HOME", Path.home() / ".hollycode"))
DATA_DIR = _HOLLYCODE_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
