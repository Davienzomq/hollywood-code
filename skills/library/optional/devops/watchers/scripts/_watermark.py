...
def _state_dir() -> Path:
    ...
    # Default: $HOLLYCODE_HOME/watcher-state/, falling back to ~/.hollycode/watcher-state/.
    hollycode_home = os.environ.get("HOLLYCODE_HOME") or str(Path.home() / ".hollycode")
    return Path(hollycode_home) / "watcher-state"
