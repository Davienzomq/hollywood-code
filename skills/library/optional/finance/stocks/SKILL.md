...
```
SCRIPT=~/.hollycode/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.hollycode/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
