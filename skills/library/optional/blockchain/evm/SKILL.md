...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Hollycode
license: MIT
...
Helper script path: `~/.hollycode/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.hollycode/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.hollycode/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.hollycode/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
