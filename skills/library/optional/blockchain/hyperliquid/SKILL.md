...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), Hollycode
license: MIT
...
The script reads `${HOLLYCODE_HOME:-~/.hollycode}/.env` for two optional defaults:
...
Helper script: `~/.hollycode/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.hollycode/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${HOLLYCODE_HOME:-~/.hollycode}/.env`.
...
```bash
python3 ~/.hollycode/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.hollycode/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
