...
## Hollycode Integration

This skill is designed for the Hollycode agent. It uses Hollycode tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Hollycode skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.hollycode/plans/` | `skill_view("plan")` |
