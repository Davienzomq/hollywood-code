...
```bash
python3 -m pyfiglet "HOLLYCODE" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=HOLLYCODE&font=Slant" | boxes -d stone
```
