...
Built for [Hollycode](https://github.com/NousResearch/hollycode). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/hollycode/skills/creative/ascii-video`](https://github.com/NousResearch/hollycode/tree/main/skills/creative/ascii-video) via PR.
