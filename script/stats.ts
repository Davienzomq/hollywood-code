...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Davienzomq/hollywood-code/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Davienzomq/hollywood-code...\n")
...
console.log("Fetching npm all-time downloads for hollycode...\n")
const npmDownloads = await fetchNpmDownloads("hollycode")
